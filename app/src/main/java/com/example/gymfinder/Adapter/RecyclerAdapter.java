package com.example.gymfinder.Adapter;
...
public  class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.RecyclerViewHolder>{
    ...
    public RecyclerAdapter(Context context, List<Gym> uploads) {
        mContext = context;
        gyms = uploads;
    }
    ...
    public void onBindViewHolder(RecyclerViewHolder holder, int position) {
        ...
        holder.nameTextView.setText(currentGym.getName());
        holder.descriptionTextView.setText(currentGym.getDescription());
    ...
    public class RecyclerViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener,
        ...
        public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
            ...
            MenuItem updateItem = menu.add(Menu.NONE, 3, 3, "Update");
